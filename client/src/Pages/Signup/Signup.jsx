        ...
        <form id="signup-form" onSubmit={handleSubmit}>
            <section>
                ...
                <div className="signin">
                    <div className="main-box pt-0 rounded-md max-w-sm w-full text-white text-left">
                        ...
                        <div className="signup">
                            <div className="form">
                                <div className="flex flex-col gap-2">
                                    ...
                                    <div className="input-username flex">
                                        <input
                                    ...
                                    <div className="flex gap-3 mt-2">
                                        <img
                                            src={showPass ? "../../../assets/OpenEye.svg" : "../../../assets/CloseEye.svg"}
                                            onClick={handlePasswordToggle}
                                            className="hover:cursor-pointer"
                                            alt="Toggle Password Visibility"
                                        />
                                        <p onClick={handlePasswordToggle} className="hover:cursor-pointer">
